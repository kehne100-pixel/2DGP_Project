...
class Keroro:
    def __init__(self):
        ...
        self.SKILL2      = Skill2(self)       # 숫자 2 스킬2
        ...
        self.state_machine = StateMachine(
            self.IDLE,
            {
                ...
                self.IDLE: {
                    ...
                    skill2_down:    self.SKILL2,   # 2 → Skill2
                },
                ...
                self.RUN: {
                    ...
                    skill_down:     self.SKILL,    # 달리면서 Skill1
                    skill2_down:    self.SKILL2,   # 달리면서 Skill2
                },
